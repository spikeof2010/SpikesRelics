...
public class ToyHorse extends CustomRelic {
    public static final String ID = "ToyHorse";
    private static final String IMG = "images/relics/ToyHorse.png";
    private static final String OUTLINE = "images/relics/outline/ToyHorse.png";
