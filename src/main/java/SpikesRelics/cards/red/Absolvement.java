...
import SpikesRelics.powers.AbsolvementPower;
        ...
        extends AbstractCard
{
    ...
    public Absolvement()
    {
        super("Absolvement", NAME, "status/beta", "status/beta", 1, DESCRIPTION, AbstractCard.CardType.POWER, AbstractCard.CardColor.RED, AbstractCard.CardRarity.UNCOMMON, CardTarget.SELF);
